...
@section('content') 
    <div class="modal">
        ...
        <p>作成日</p>
            <input type="date" name="created_at_from" value="{{session('created_at_from')}}">~
            <input type="date" name="created_at_to" value="{{session('created_at_to')}}">
            <p>更新日</p>
            <input type="date" name="updated_at_from" value="{{session('updated_at_from')}}">~
            <input type="date" name="updated_at_to" value="{{session('updated_at_to')}}">
            <p>コメント</p>
